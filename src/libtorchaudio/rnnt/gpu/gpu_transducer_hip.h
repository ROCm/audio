...
#include <libtorchaudio/rnnt/gpu/gpu_kernel_utils_hip.cuh>
#include <libtorchaudio/rnnt/gpu/gpu_kernels_hip.cuh>
#else
...
status_t LogSumExp2D(
  ...
  { // compute max among D.
   ...
   hipLaunchKernelGGL(( ReduceMax2D<REDUCE_THREADS, DTYPE, CAST_DTYPE>)
        , dim3(block_dims), dim3(thread_dims), 0, stream, 
            /*dim=*/D,
            /*inputs=*/logits,
            /*outputs=*/outputs);
  ...
  { // compute log(sum(exp(d_i - max)))
   ...
   hipLaunchKernelGGL(( ReduceLogSumExpGivenMax2D<REDUCE_THREADS, DTYPE, CAST_DTYPE>)
        , dim3(block_dims), dim3(thread_dims), 0, stream, 
            /*dim=*/D,
            /*inputs=*/logits,
            /*outputs=*/outputs);
...
status_t Compute(
  ...
  { // compute log probability pairs (blank and target).
   ...
   hipLaunchKernelGGL(( ComputeLogProbs<DTYPE, CAST_DTYPE>), dim3(block_dims), dim3(thread_dims), 0, stream, 
        /*max_src_len=*/max_T,
        /*max_tgt_len=*/max_U,
        /*num_targets=*/D,
        /*blank=*/blank,
  ...
  { // compute alphas, betas and costs.
   ...
   hipLaunchKernelGGL(( ComputeAlphasBetasCosts<DTYPE, CAST_DTYPE>)
        , dim3(block_dims), dim3(thread_dims), 0, stream, 
            /*max_src_len=*/max_T,
            /*max_tgt_len=*/max_U,
            /*num_targets=*/D,
  ...
  if (gradients != nullptr) { // compute gradients.
   ...
   hipLaunchKernelGGL(( ComputeGradients<DTYPE, CAST_DTYPE>), dim3(block_dims), dim3(thread_dims), 0, stream, 
        /*max_src_len=*/max_T,
        /*max_tgt_len=*/max_U,
        /*num_targets=*/D,
        /*blank=*/blank,
...
status_t ComputeAlphas(
  ...
  { // compute alphas
   ...
   hipLaunchKernelGGL(( ComputeAlphasWrapper<DTYPE, CAST_DTYPE>)
        , dim3(block_dims), dim3(thread_dims), 0, stream, 
            /*max_src_len=*/max_T,
            /*max_tgt_len=*/max_U,
            /*num_targets=*/D,
...
status_t ComputeBetas(
  ...
  { // compute betas
   ...
   hipLaunchKernelGGL(( ComputeBetasWrapper<DTYPE, CAST_DTYPE>)
        , dim3(block_dims), dim3(thread_dims), 0, stream, 
            /*max_src_len=*/max_T,
            /*max_tgt_len=*/max_U,
            /*num_targets=*/D,
